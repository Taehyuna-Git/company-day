...
## 2026-09-14 기념일 메일 구현
기념일 발송 DB와 Supabase Edge Function, Cron(발송 비활성), 테스트 메일 UI를 구현했습니다. 상세 상태와 연결 순서는 ANNIVERSARY-MAIL.md에 있습니다. 함수 인증 설정 승인과 SMTP_PASSWORD 입력 및 실제 수신 검증이 남아 있어 자동 메일은 아직 발송하지 않습니다. Google 로그인은 이전에 실제 성공 확인을 마쳤습니다.
