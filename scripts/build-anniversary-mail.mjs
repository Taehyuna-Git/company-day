...
const verification=await fs.readFile('supabase/functions/anniversary-mail/verification.ts','utf8');
await fs.writeFile('supabase/generated/anniversary-mail.ts',core+'\n'+verification.replace(/^import type[^\n]*\n/,'')+'\n'+index.replace(/^import .* from '\.\/(core|verification)\.ts';\r?\n/gm,''));
